...
- [Remove faulty Assert in partitioned `INSERT...ON CONFLICT DO UPDATE`](https://git.postgresql.org/gitweb/?p=postgresql.git;a=commit;h=4b760a181ab220f425a6fe8e08335891b0ba62d4)
