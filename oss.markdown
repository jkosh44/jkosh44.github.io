...
- [Remove some dependence on signed integer wrapping](https://git.postgresql.org/gitweb/?p=postgresql.git;a=commit;h=9e9a2b7031f64e49fcaf28f21a4e70eb1212165f)
